...
global.anitav4 = process.env.BOT_NAME || "Eden";
global.ownername = process.env.OWNER_NAME || "Atomic";
global.packname = process.env.PACK_NAME || "Eden";
global.author = process.env.AUTHOR || "Atomic";
global.channelname = process.env.CHANNEL_NAME || "Atomicend";
